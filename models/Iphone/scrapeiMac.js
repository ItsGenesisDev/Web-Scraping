...
const baseUrl = 'https://everymac.com/systems/apple/imac/index-imac.html';

async function scrapeiMac() {
  try {
    ...
    const filePath = path.join(jsonsFolderPath, 'alliMacinfo.json');
...
async function getDeviceInfo(url) {
  try {
    ...
    const ramDevice = $('#specs15-title tbody tr td').eq(1).text().trim();
